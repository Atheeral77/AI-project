...
for wheel in wheels:
    wheel.setVelocity(-14.81)
robot.step(230 * timestep)


wheels[0].setVelocity(2.7)
wheels[1].setVelocity(-2.7)
wheels[2].setVelocity(2.7)
wheels[3].setVelocity(-2.7)
armMotors[0].setPosition(-0.12)
armMotors[1].setPosition(-1.13)
armMotors[2].setPosition(-0.35)
armMotors[3].setPosition(-0.35)
robot.step(395 * timestep)
for wheel in wheels:
